...
namespace Api_tarefas.Controllers
{
    ...
    {
        private readonly TarefaItemContexto _context;

        public TarefaItemsController(TarefaItemContexto context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<TarefaItem>> PostTarefaItem(TarefaItem tarefaItem)
        {
          if (_context.Tarefas == null)
          {
              return Problem("Entity set 'TarefaItemContexto.Tarefas'  is null.");
          }
